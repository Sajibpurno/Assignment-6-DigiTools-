    ...
    return (
        <div className="w-full">
            ...
            {cart.length > 0 ? (
                ...
                <button onClick={handleCheckout} className=' w-full btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] hover:bg-[#7a25e6] mt-5 text-white text-2xl rounded-full py-10'>Proceed to Checkout</button>
                </div>
